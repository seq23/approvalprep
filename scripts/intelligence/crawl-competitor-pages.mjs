...
const connectorId="competitor_public_crawler";
...
const watch=readJson("data/intelligence/competitor_watchlist.json",{competitors:[]}).competitors.filter(c=>c.allowed); const snapshots=[];
