...
for(const r of runs.runs){ if(!["COMPLETE","COMPLETE_FIXTURE","NOT_CONFIGURED","SOURCE_ERROR","NO_DATA","BUDGET_HELD"].includes(r.status)) fail(`[intelligence-source-freshness] invalid status ${r.status}`); }
