...
const sequences = {
  daily: ['content:generate','content:demand-opportunities','content:generate-pages','content:generate-atoms-expanded','governance:safe-harbor:all','content:self-heal-citation-os','intelligence:internal-links','content:apply-internal-links','seo:sitemap','citation-handoff:all','metrics:content-velocity','metrics:citation-scoreboard','workflows:trace','validate:all'],
